...
function! tinytoolchiyl#base#asyncid_to_info#doit()
    "let s:in='.vimtmp.in.asyncid_to_info'
    "let s:out='.vimtmp.out.asyncid_to_info'
    ...
    silent! execute 'python' . (has('python3') ? '3' : '') . ' asyncid_to_info("'.s:in.'","'.s:out.'")'
